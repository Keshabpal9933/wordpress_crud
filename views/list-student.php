<?php
    ...
    if(!empty($action) && $action=="delete"){
        ...
        if(count($row_exists) > 0){
            ...
            ?>
            <script>
                location.href="<?php site_url() ?>/wp-admin/admin.php?page=wp-next-plugin";
            </script>
            <?php
        }
    }
            ...
            ?>
                <tr>
                    ...
                    <td>
                        ...
                        <a href="admin.php?page=wp-next-plugin&id=<?php echo $student['id']; ?>&action=delete" onclick="return confirm('Are you sure to delete?')">Delete</a>
                    </td>
                </tr>
            <?php
        }
